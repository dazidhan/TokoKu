...
<div class="space-y-6">
    ...
    <div class="animate-slide-up" style="animation-delay: 100ms;">
        ...
        <div class="grid grid-cols-4 gap-2">
            <a href="{{ route('kasir') }}" class="flex flex-col items-center gap-2 rounded-2xl border border-border bg-card p-3 shadow-card transition-all duration-200 hover:shadow-card-hover active:scale-95">
                ...
                <span class="text-[10px] font-medium text-muted-foreground text-center leading-tight">Transaksi Baru</span>
            </a>
            ...
            <a href="{{ route('stok') }}" class="flex flex-col items-center gap-2 rounded-2xl border border-border bg-card p-3 shadow-card transition-all duration-200 hover:shadow-card-hover active:scale-95">
                ...
                <span class="text-[10px] font-medium text-muted-foreground text-center leading-tight">Scan Produk</span>
            </a>
        ...
        <div class="space-y-2">
            <div class="flex items-center gap-3 rounded-2xl border border-border bg-card p-4 shadow-card hover:shadow-card-hover transition-all">
                ...
                <div class="flex-1 min-w-0">
                    <p class="truncate text-sm font-semibold text-foreground">Budi Santoso</p>
                    <p class="text-xs text-muted-foreground">5 item • 10 menit lalu</p>
                </div>
                <div class="text-right">
                    <p class="text-sm font-bold text-foreground">Rp 250.000</p>
            ...
            <div class="flex items-center gap-3 rounded-2xl border border-border bg-card p-4 shadow-card hover:shadow-card-hover transition-all">
                ...
                <div class="flex-1 min-w-0">
                    <p class="truncate text-sm font-semibold text-foreground">Ahmad Fauzi</p>
                    <p class="text-xs text-muted-foreground">8 item • 1 jam lalu</p>
                </div>
                <div class="text-right">
                    <p class="text-sm font-bold text-foreground">Rp 450.000</p>
                    <span class="inline-block rounded-full bg-warning/10 px-2 py-0.5 text-[10px] font-medium text-warning">Pending</span>
                </div>
            </div>
        </div>
    </div> --}}
    ...
    <div class="animate-slide-up space-y-3" style="animation-delay: 200ms;">
        ...
        <div class="space-y-2">
            ...
            @empty
            <div class="text-center py-4 text-muted-foreground text-sm">Belum ada transaksi hari ini</div>
            @endforelse
        </div>
    </div>
</div>
